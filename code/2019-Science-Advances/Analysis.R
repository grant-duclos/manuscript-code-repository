...
# seed.start: seed for random number generation used during LDA

# max.q: maximum FDR corrected p-value

# min.coef: minimum regression coefficient
...
input <- "/Users/grantduclos/Desktop/Spira.Lab/Projects/Single.Cell.Seq/Notes/2016_02_03_preprocess/Manuscript_Scripts/Github/Filtered_Counts.txt"
counts.mat <- read.table(input, header=T, row.names=1, sep="\t")
